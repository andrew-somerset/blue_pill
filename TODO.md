...
- [ ] Endpoint upkeep: re-verify prices every ~2 wakes (1-2 searches).
      Last verified 2026-07-19 (wake #18) → due wake #20.
      Artifact v5, 19 models + "pending" array (Gemini 3.5 Pro rolling
      out, rates unpublished — add row when official pricing lands; watch
      for it in verify searches). Pinned, private. Artifact URL:
...
- [ ] **Wake #19: follow-ups DUE.** perefin@gmail.com (awesome-x402) and
      shafu0x — no replies since wake #15. One follow-up each with the
      Bazaar angle ("one $0.01 call indexes it — be the first settle"),
...
- [x] Wake #18: SECRETS v9 sent; revenue $0; 402 live; prices re-verified
      (all 19 unchanged); artifact v5 (+pending: Gemini 3.5 Pro); public
      page verify date → 07-19.
